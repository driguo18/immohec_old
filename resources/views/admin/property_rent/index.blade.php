    ...
    <div id="page-content">
        ...
        <div class="block full">
            <div class="block-section">
                <a href="{{ route('admin.property_rent.create') }}" data-toggle="modal">
                        ...
                        @foreach($properties as $key=>$property)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.property_rent.edit',$property->id) }} " data-toggle="tooltip" title="Modifier ce bien" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                    <button data-toggle="tooltip" title="Supprimer ce bien" class="btn btn-effect-ripple btn-xs btn-danger" type="button"
                                    onclick="deleteProperty({{ $property->id }})">
                                        <i class="fa fa-times"></i></button>
                                    <form id="delete-form-{{ $property->id }}" action="{{ route('admin.property_rent.destroy', $property->id) }}" method="POST" style="display: none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
