            ...
            <div class="col-sm-6 col-lg-4">
                ...
                <a href="page_ready_profile.html" class="widget">
                    ...
                    <div class="widget-content border-bottom text-center themed-background-muted">
                        <img src="{{ asset('assets/backend/img/placeholders/avatars/avatar13@2x.jpg') }}" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar-2x">
            ...
            <div class="col-sm-4">
                ...
                <div class="widget">
                    ...
                    <a href="javascript:void(0)" class="widget-content themed-background-muted text-right clearfix">
                        <img src="{{ asset('assets/backend/img/placeholders/avatars/avatar6.jpg') }}" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar pull-left">
                    ...
                    <a href="javascript:void(0)" class="widget-content themed-background-muted border-top text-right clearfix">
                        <img src="{{ asset('assets/backend/img/placeholders/avatars/avatar2.jpg') }}" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar pull-left">
                    ...
                    <a href="javascript:void(0)" class="widget-content themed-background-muted border-top text-right clearfix">
                        <img src="{{ asset('assets/backend/img/placeholders/avatars/avatar11.jpg') }}" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar pull-left">
            ...
            <div class="col-sm-4">
                ...
                <div class="widget">
                    ...
                    <div class="widget-image">
                        <img src="{{ asset('assets/backend/img/placeholders/photos/photo9.jpg') }}" alt="image">
